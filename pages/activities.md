  ...
  <div class="splide__track">
    <ul class="splide__list">
      <li class="splide__slide">
        <img src="/assets/img/cinc_2026/activities/morcuera.jpeg" alt="Puerto de La Morcuera" style="width:100%; max-height:350px; object-fit:cover; border-radius:6px;">
      </li>
      <li class="splide__slide">
        <img src="/assets/img/cinc_2026/activities/navacerrada.jpg" alt="Puerto de Navacerrada" style="width:100%; max-height:350px; object-fit:cover; border-radius:6px;">
      </li>
    </ul>
  </div>
</div> -->
...
<div id="austrias-carousel" class="splide" aria-label="Habsburg Madrid Photos" style="max-width: 600px; margin: 1em 0;">
  <div class="splide__track">
    <ul class="splide__list">
      <li class="splide__slide">
        <img src="/assets/img/cinc_2026/plaza_mayor.jpg" alt="Plaza Mayor" style="width:100%; max-height:350px; object-fit:cover; border-radius:6px;">
      </li>
      <li class="splide__slide">
        <img src="/assets/img/cinc_2026/royal_palace.jpg" alt="Royal Palace" style="width:100%; max-height:350px; object-fit:cover; border-radius:6px;">
      </li>
    </ul>
  </div>
</div>
