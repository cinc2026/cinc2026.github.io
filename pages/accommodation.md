...
Start booking now, as accommodation in Madrid is in high demand in September. Alternative nearby hotels with special conference rates are also listed below, together with their discount codes and direct booking links.
{: .text-justify}


Please see the below options and walking distances.
{: .text-justify}
...
- **Extra nights:** If you want to book extra nights, before or after the event, at the hotel at the agreed conference rate, please contact the hotel directly and mention **CINC** and the extra nights desired, using the following contacts:
...
- Discount code: **CINC2026**
- Booking link for the conference: [RESERVATION LINK for CinC](https://www.madrono-hotel.com/habitaciones-con-cocina-hotel-madrid/){: .btn .btn--info .btn--small}{: target="_blank"}
...
<div style="display: flex; justify-content: flex-start; align-items: flex-start; gap: 30px; flex-wrap: wrap; margin-bottom: 2em;">
  ...
  <div style="flex: 0 0 auto; align-self: center;">
    <table style="border-collapse:collapse; margin:0; font-size:0.82em;">
      ...
      <tbody>
        <tr>
          <td style="background-color:#9b1a2a; color:#ffffff; padding:6px 14px; border:1px solid #7a1020;">213 €</td>
          <td style="background-color:#9b1a2a; color:#ffffff; padding:6px 14px; border:1px solid #7a1020;">231 €</td>
        </tr>
        <tr>
          <td style="background-color:#6b6b6b; color:#ffffff; padding:6px 14px; border:1px solid #555555;">Breakfast and Taxes Included</td>
          <td style="background-color:#6b6b6b; color:#ffffff; padding:6px 14px; border:1px solid #555555;">Breakfast and Taxes Included</td>
...
<div id="vpmadrono-carousel" class="splide" aria-label="Novotel Madrid Center Photos" style="max-width:800px; margin:1em auto 2em;">
  <div class="splide__track">
    <ul class="splide__list">
      <li class="splide__slide">
        <img src="/assets/img/cinc_2026/accomodations/vp_madronho/vp_mad_1.jpg" alt="Novotel Madrid Center - Photo 1" style="width:100%; height:340px; object-fit:contain;">
      </li>
      <li class="splide__slide">
        <img src="/assets/img/cinc_2026/accomodations/vp_madronho/vp_mad_2.jpg" alt="Novotel Madrid Center - Photo 2" style="width:100%; height:340px; object-fit:contain;">
      </li>
      <li class="splide__slide">
        <img src="/assets/img/cinc_2026/accomodations/vp_madronho/vp_mad_3.jpg" alt="Novotel Madrid Center - Photo 3" style="width:100%; height:340px; object-fit:contain;">
      </li>
      <li class="splide__slide">
