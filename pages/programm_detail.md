...
layout: single
author_profile: true
permalink: /programm_detail/
---

## Scientific Programme Detail

<div>
    <div title="Whova event and conference app" id="whova-agendawidget">
        <p id="whova-loading">Loading...</p>
    </div>
    <script src="https://whova.com/static/frontend/xems/js/embed/embedagenda.js?eid=Cw8BkET3HVjqQCLaiRF46wISvgtK2yvY%40sdDWrFGfyE%3D&host=https://whova.com" type="text/javascript"  id="embeded-agenda-script">
    </script>
